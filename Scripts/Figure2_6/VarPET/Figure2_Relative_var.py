...
for j in range(0, len(files)):
    ...
    fileMCWD = os.path.join(setup.MCWDrootPAthVarET, setup.files_varpet[j][1])
    ...
    relMcwdData = fileMcwd2.ParseRelativeDeviation(2001, 2016)
...
df.to_csv(r'2005-2010-2016Areas_VARET.tsv', sep= '\t', header = True)