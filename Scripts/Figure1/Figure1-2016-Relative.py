...
cmapPrec = mpl.colors.ListedColormap(['tab:red',
                                      'tab:orange',
                                      'white',
                                      'tab:green',
                                      'tab:blue',
...
for j in range(0, len(scenNames)):
    ...
    #patches.append(mpatches.Patch(label='x < -4', facecolor='#fe0003', edgecolor='black'))
    #patches.append(mpatches.Patch(label='-4 < x < -3', facecolor=cmapPrec.colors[0], edgecolor='black'))
    #patches.append(mpatches.Patch(label='-3 < x < -2', facecolor=cmapPrec.colors[1], edgecolor='black'))
    #patches.append(mpatches.Patch(label='-2 < x < -1', facecolor=cmapPrec.colors[2], edgecolor='black'))
    ...
    plt.savefig(scenNames[j]+ "_relative.jpg", dpi=600)
